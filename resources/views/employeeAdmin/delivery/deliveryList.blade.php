        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex mt-4">
                    ...
                    <div class="col-md-3">
                <a href="{{route('employeeAdmin/delivery/create')}}" class="btn btn-primary">Add Delivery</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/employeeAdmin/delivery/edit/'.$delivery->id)}}" class=" btn btn-info">Edit</a>
                                        {{-- <form action="{{route('employee.destroy',$employee->id)}}" method='post' class="d-inline"> --}}
                                        <form action="{{url('/employeeAdmin/delivery/delete/'.$delivery->id)}}" method='post' class="d-inline">
                                            @csrf
                                            @method('DELETE')
